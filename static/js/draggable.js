...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Get shuffle and lineup buttons
    ...
    function initializeDraggables() {
        ...
        draggables.forEach(el => {
            ...
            // Math do generate boxes not overlapping
            do {
    ...
    // Re-line up boxes when window is resized
